...
const EnvelopeControls = ({ synth1, synth2 }) => {
    ...
    const handleAttackChange = useCallback((value) => {
    ...
    const handleDecayChange = useCallback((value) => {
    ...
    const handleSustainChange = useCallback((value) => {
    ...
    const handleReleaseChange = useCallback((value) => {
    ...
    return (<div className="control-container envelope-container">
      ...
      <div className="row justify-center">
        <div className="column hasTooltip">
          <Slider min={0} max={2} step={0.01} width={50} height={96} value={attack} onValueChange={handleAttackChange}/>
        ...
        <div className="column hasTooltip">
          <Slider min={0} max={2} step={0.01} width={50} height={96} value={decay} onValueChange={handleDecayChange}/>
          <label className="unselectable title-small">DEC</label>
          <span className="tooltip unselectable value">{decay.toFixed(3)}</span>
        </div>
        <div className="column hasTooltip">
          <Slider min={0} max={1} step={0.01} width={50} height={96} value={sustain} onValueChange={handleSustainChange}/>
        ...
        <div className="column hasTooltip">
          <Slider min={0} max={5} step={0.01} width={50} height={96} value={release} onValueChange={handleReleaseChange}/>
